        ...
        <div className={styles.module}>
          ...
          <div style={{ display: 'grid', gap: '20px', padding: '40px 20px' }}>
            <section style={{ display: 'flex', gap: '20px' }}>
              <div style={{ borderRadius: '25px', textAlign: "center", width: "100%", backgroundColor: "#000000D0", backgroundImage: `url("bear.png")`, backgroundSize: 'contain' }}>
                <h2>Bearish</h2>
                <p>~Continuously mint and short squeeth while maintaining collateral ratio~</p>
                <div style={{ borderRadius: '25px', backgroundColor: "green" }}>
                  <h2>a</h2>
                  <h3>e</h3>
                </div>
                <section style={{ display: 'flex', gap: '20px' }}>
                  <div style={{ borderRadius: '25px', backgroundColor: "red", width: "50%", textAlign: "center" }}>
